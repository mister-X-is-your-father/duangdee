...
const INSIGHTS = [   // 2本目から短縮 (18秒→15秒目標。読み上げは1文)
  { tts: `สัปดาห์นี้ ใส่${day.lucky[0]}นะลูก… ${day.avoid[0]}พักไว้ก่อน` },
  { tts: `อาทิตย์นี้ ${day.lucky[0]}คือสีของคุณ… เลี่ยง${day.avoid[0]}นะ` }
];
